...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXTwitter",
			url: "https://pkgs.genexus.dev/iOS/beta/GXTwitter-1.0.0-beta+20230609175617.xcframework.zip",
			checksum: "9286809f64b6e857c9ad846dc69bf0a5ffe31a9e530ff06a9bbcd7a979e9e92e"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXTwitter",
			url: "https://pkgs.genexus.dev/iOS/beta/GXTwitter-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "45a262c65609af33ee24c495f3023df52aa9c82082d3d1d832996dbe60b6bd3c"
		)
	]
)